...
public class FilterPanelViewModel
{
    ...
    private void Refresh()
    {
        ...
        if (isCCVisible)
        {
            ...
            if (FilterCostCentersViewModel.MainComboBoxSelectedIndex == 0
                        && FilterCostCentersViewModel.OtherComboBoxSelectedIndex == 0
                        && FilterCostCentersViewModel.SlaveComboBoxSelectedIndex == 0)
                filterSet.TitleSelectedCCGroup = "все";
            else if (FilterCostCentersViewModel.MainComboBoxSelectedIndex > 0
                        | FilterCostCentersViewModel.OtherComboBoxSelectedIndex > 0
                        | FilterCostCentersViewModel.SlaveComboBoxSelectedIndex > 0)
                filterSet.TitleSelectedCCGroup = SelectedCC[0].Name;
            ...
            else
            {
                if (FilterCostCentersViewModel.MainComboBoxSelectedIndex == 0
                        && FilterCostCentersViewModel.OtherComboBoxSelectedIndex < 0
                        && FilterCostCentersViewModel.SlaveComboBoxSelectedIndex < 0)
                    filterSet.TitleSelectedCCGroup = "технологические основные";
                else if (FilterCostCentersViewModel.MainComboBoxSelectedIndex < 0
                        && FilterCostCentersViewModel.OtherComboBoxSelectedIndex == 0
                        && FilterCostCentersViewModel.SlaveComboBoxSelectedIndex < 0)
                    filterSet.TitleSelectedCCGroup = "технологические прочие";
                else if (FilterCostCentersViewModel.MainComboBoxSelectedIndex < 0
                        && FilterCostCentersViewModel.OtherComboBoxSelectedIndex < 0
                        && FilterCostCentersViewModel.SlaveComboBoxSelectedIndex == 0)
                    filterSet.TitleSelectedCCGroup = "вспомогательные";
                else if (FilterCostCentersViewModel.MainComboBoxSelectedIndex == 0
                        && FilterCostCentersViewModel.OtherComboBoxSelectedIndex == 0
                        && FilterCostCentersViewModel.SlaveComboBoxSelectedIndex < 0)
                    filterSet.TitleSelectedCCGroup = "все технологические";

                else filterSet.TitleSelectedCCGroup = "выборочно";
            }
        ...
        if (isERVisible)
        {
            ...
            if (FilterEnergyResourcesViewModel.PrimeComboBoxSelectedIndex == 0
                        && FilterEnergyResourcesViewModel.SecondaryComboBoxSelectedIndex == 0)
                filterSet.TitleSelectedERGroup = "все";
            else if (FilterEnergyResourcesViewModel.PrimeComboBoxSelectedIndex > 0
                        && FilterEnergyResourcesViewModel.SecondaryComboBoxSelectedIndex < 0)
                filterSet.TitleSelectedERGroup = SelectedER[0].Name;
            else if (FilterEnergyResourcesViewModel.PrimeComboBoxSelectedIndex < 0
                        && FilterEnergyResourcesViewModel.SecondaryComboBoxSelectedIndex > 0)
                filterSet.TitleSelectedERGroup = SelectedER[0].Name;
            else if (FilterEnergyResourcesViewModel.PrimeComboBoxSelectedIndex == 0
                        && FilterEnergyResourcesViewModel.SecondaryComboBoxSelectedIndex < 0)
                filterSet.TitleSelectedERGroup = "первичные";
            else if (FilterEnergyResourcesViewModel.PrimeComboBoxSelectedIndex < 0
                        && FilterEnergyResourcesViewModel.SecondaryComboBoxSelectedIndex == 0)
                filterSet.TitleSelectedERGroup = "вторичные";
            else filterSet.TitleSelectedERGroup = "выборочно";
